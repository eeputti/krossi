...
// koutsi-valmentaja-app.jsx — both load the same koutsi-auth.jsx file.
window.KOUTSI_APP_NAME = 'koutsi_pelaaja';
...
function ProfileView({ student, groups, state, onSignOut, onReload }) {
  ...
  return (
    <div>
      ...
      {feedbackOpen && <window.KoutsiFeedbackModal userId={student.id} onClose={() => setFeedbackOpen(false)} />}
    </div>
  );
}

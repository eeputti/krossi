...
function NavIcon({ id, on, size }) {
  ...
  if (id === 'students') return <svg width={size} height={size} viewBox="0 0 22 22" fill="none"><circle cx="8" cy="6.5" r="3" stroke={c} strokeWidth={sw} /><path d="M2 19c0-3.2 2.7-5.3 6-5.3s6 2.1 6 5.3" stroke={c} strokeWidth={sw} strokeLinecap="round" /><circle cx="16" cy="7.5" r="2.4" stroke={c} strokeWidth={sw} /><path d="M13.8 19c.3-2.6 2.1-4.3 4.2-4.3S21.7 16.4 22 19" stroke={c} strokeWidth={sw} strokeLinecap="round" /></svg>;

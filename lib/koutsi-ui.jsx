...
function KoutsiWelcomeModal({ onClose }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 90, background: 'rgba(10,15,10,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: 'min(440px, 100%)', maxHeight: '90vh', overflowY: 'auto', background: 'var(--sand)', borderRadius: 18, animation: 'kFadeIn .2s ease', boxShadow: '0 24px 64px -20px rgba(0,0,0,0.6)' }}>
        <div style={{ background: 'var(--green-deep)', borderRadius: '18px 18px 0 0', padding: '20px 26px' }}>

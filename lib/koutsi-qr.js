...
(function () {
  ...
  // Builds up low-degree-first ([x^0, x^1, ...]), but rsRemainder's shift-register division
  // walks it as [x^degree, ..., x^1, x^0] (gen[0] is the implicit leading 1, gen[1..] are
  // the LFSR taps) — reverse before returning so the two agree on which end is which.

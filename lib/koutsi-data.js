...
async function koutsiAddMatchNote(studentId, { opponentName, date, note, durationMinutes, result, format, score }) {
...
async function koutsiUpdateMatchNote(noteId, { opponentName, date, note, durationMinutes, result, format, score }) {

...
const KOUTSI_STORE_KEY = 'krossiKoutsiDemoV5';
...
function koutsiBuildSeedTrainings() {
  ...
  return [
    { id: 0, date: koutsiOffsetDateStr(2), time: '17:00', type: 'Yksityistunti', studentId: 0, groupId: null },
    { id: 1, date: koutsiOffsetDateStr(kilpa), time: '17:00', type: 'Ryhmätreeni', studentId: null, groupId: 0 },
    { id: 2, date: koutsiOffsetDateStr(keski), time: '16:00', type: 'Ryhmätreeni', studentId: null, groupId: 1 },
    { id: 3, date: koutsiOffsetDateStr(alkeis), time: '10:00', type: 'Ryhmätreeni', studentId: null, groupId: 2 },
    { id: 4, date: koutsiOffsetDateStr(kilpa + 7), time: '17:00', type: 'Ryhmätreeni', studentId: null, groupId: 0 },
    { id: 5, date: koutsiOffsetDateStr(keski + 7), time: '16:00', type: 'Ryhmätreeni', studentId: null, groupId: 1 },
    { id: 6, date: koutsiOffsetDateStr(alkeis + 7), time: '10:00', type: 'Ryhmätreeni', studentId: null, groupId: 2 },
    { id: 7, date: koutsiOffsetDateStr(21), time: '11:00', type: 'Ottelu', studentId: 3, groupId: null },
  ];
}
...
Object.assign(window, {
  ...
  koutsiTrainingsOnDate, koutsiNextTrainingId, koutsiLevelColor,

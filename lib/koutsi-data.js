...
function koutsiMapStudent(studentRow, profileRow, diaryRows, homeworkRows, videoRows, moodRows, matchNoteRows, historyRows) {
  ...
  return {
    ...
    matchNotes: (matchNoteRows || []).filter((n) => n.student_id === studentRow.id).map((n) => ({
      ...
      partnerName: n.partner_name || '', opponent2Name: n.opponent2_name || '',
    })),
...
async function koutsiAddMatchNote(studentId, { opponentName, date, note, durationMinutes, result, format, score, partnerName, opponent2Name }) {
...
async function koutsiUpdateMatchNote(noteId, { opponentName, date, note, durationMinutes, result, format, score, partnerName, opponent2Name }) {
